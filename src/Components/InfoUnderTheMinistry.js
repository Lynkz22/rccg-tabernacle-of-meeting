      ...
      >
        ...
        <div className="divHomeUnderTheMinistryContent">
          <p className="underTheMinistryContent">
            RCCG Tabernacle of Meeting is guided by the visionary leadership and
            anointed ministry of our General Overseer, Pastor E.A. Adeboye, we
            are committed to pursuing holiness, spreading the Gospel, and
...
export default InfoUnderTheMinistry;
